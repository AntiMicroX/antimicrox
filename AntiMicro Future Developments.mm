...
<node CREATED="1398676376577" FOLDED="true" HGAP="19" ID="ID_1223827762" MODIFIED="1420094536905" POSITION="left" TEXT="Split Actions into a Seperate Entity?" VSHIFT="-5">
<icon BUILTIN="help"/>
...
<node CREATED="1420094449038" FOLDED="true" HGAP="22" ID="ID_287590243" MODIFIED="1420094830865" POSITION="right" TEXT="Use uinput by default and fallback to XTest if necessary." VSHIFT="-5">
...
<node CREATED="1420094472645" FOLDED="true" ID="ID_1669687536" MODIFIED="1420095045730" POSITION="left" TEXT="Allow logging as long as it doesn&apos;t cause button lag.">
