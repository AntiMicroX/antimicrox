...
class QtX11KeyMapper : public QObject
{
    Q_OBJECT
public:
    static KeySym returnVirtualKey(unsigned int qkey);
    static unsigned int returnQtKey(KeySym key);
...
protected:
    ...
    QHash<unsigned int, KeySym> qtKeyToX11KeySym;
    QHash<KeySym, unsigned int> X11KeySymToQtKey;
