...
private:
    ...
    void readXmlNamesShort(QStringRef name, QXmlStreamReader *xml);
    void readXmlNamesMiddle(QStringRef name, QXmlStreamReader *xml);
    void readXmlNamesLong(QStringRef name, QXmlStreamReader *xml);
